...
export const messages: MessagesKey = {
  ...
  creatorDryRunFormLabel: 'Essai',
  creatorDryRunFormLabelTooltip:
    'Ne va pas exporter l\'offre, mais simplement créer le fichier Netex pour pouvoir l\'analyser',
  creatorFromDateFormLabel: 'Date de début *',
  creatorHeader: 'Créer un export',
  creatorDescription:
    'Exporter l\'offre vers le cloud',
  creatorNameFormLabel: 'Nom *',
  creatorSaveButtonLabelText: 'Créer un export',
  creatorSavingOverlayLoaderText: 'Sauvegarde de l\'export...',
  creatorToDateFormLabel: 'Date de fin',
  creatorDateForExport: 'Date pour l\'export',
  creatorDateForExportDesc:
    'Exporter l\'offre proposant des courses dans cette fenêtre de temps',
